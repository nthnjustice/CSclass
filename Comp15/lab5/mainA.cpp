...
void expandTest1(int elements)
{
	...
	SequenceA* seq1 = new SequenceA('a');		// make a sequence
	SequenceA* seq2 = new SequenceA('b');		// and another
...
{
    SequenceA* seqTemp = new SequenceA(); 
...
{
  SequenceA* seqTemp = new SequenceA('a');
  cout << "First: " << seqTemp->first() << endl;
  cout << "Rest: " << seqTemp->rest() << endl;
}
...
{
 SequenceA* seqTemp = new SequenceA();
 SequenceA* seqTemp2 = new SequenceA('a');
...
{
  SequenceA* seqTemp = new SequenceA('a');
  SequenceA* seqTemp2 = new SequenceA('b');
...
void sizeTest()
{
  SequenceA* seqTemp = new SequenceA();
  SequenceA* seqTemp2 = new SequenceA('a');
  SequenceA* seqTemp3 = new SequenceA('b');
